...
{
    check(buffer != NULL, "Buffer can't be NULL.");
    check(data != NULL, "Data can't be NULL.");
    check(length > 0, "Write length should be greater than 0.");
...
{
    check(buffer != NULL, "Buffer can't be NULL.");
    check(target != NULL, "Target can't be NULL.");
    check(amount > 0, "Read amount should be greater than 0.");
